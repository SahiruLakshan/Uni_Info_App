    ...
    private void setClickListeners() {
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SportnewsActivity.this, NewsActivity.class);
        ...
        ivProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportnewsActivity.this, UserInfoActivity.class);
                startActivity(intent);
            }
        });
        ...
        academicBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportnewsActivity.this, AcademicnewsActivity.class);
                startActivity(intent);
            }
        });
        ...
        eventBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportnewsActivity.this, EventnewsActivity.class);
                startActivity(intent);
            }
        });
        ...
        sportBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportnewsActivity.this, SportnewsActivity.class);
                startActivity(intent);
            }
        });
